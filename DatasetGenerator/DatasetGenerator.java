...
public class DatasetGenerator 
{
    ...
    private final static int[] numbersOfUseCases = new int[]{160,170,180,190,200};
    private final static int minSize = 10;//Define the minimum size of a sample (inclusive)
    private final static int maxSize = 10;//Define the maximum size of a sample (inclusive)
