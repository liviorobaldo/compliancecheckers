...
public class DatasetGenerator 
{
    ...
    private final static int numOfSamples = 1;//Define the number of samples for each size
    ...
    public static void prolegABox(File outputFile, int size, boolean[][] distribution)
    {
        try
        {
            ...
            //pw.write(":- [ \"./prolegEng3.pl\", \"./regulative+compliance_rules.pl\" ], messageon.\n");
            pw.write(":- [ \"./prolegEng3.pl\", \"./regulative+compliance_rules.pl\" ].\n");
            ...
            for (int i = 0; i < size; i++) 
            {
                ...
                goal = goal + "violation_ev_"+i+", violation_epr_"+i+", violation_epc_"+i+", violation_er_"+i+", ";
            }
