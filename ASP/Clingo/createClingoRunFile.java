...
public class createClingoRunFile 
{
    private static String aspRulesPath = ".\\INDEXED_RULES";
    private static String aspFactsPath = "..\\..\\DatasetGenerator\\CORPUS\\ASP";
    private static String evaluationFilePath = "..\\..\\DatasetGenerator\\CORPUS\\evaluationASP-clingo.txt";
    ...
    public static void main(String[] args) 
    {
        try 
        {
            ...
            for(String fileRules:filesRules)
            {
                ...
                pw.println("python DetectViolationsOnCorpus.py "+
                    aspRulesPath+"/"+fileRules+" "+
